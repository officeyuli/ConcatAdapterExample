...
public class ButtonAdapter extends RecyclerView.Adapter<ButtonViewHolder<Integer>> {
    private List<Integer> data ;
    @NonNull
    @Override
    public ButtonViewHolder<Integer> onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
